...
interface CityDao {
     ...
     */
    def String extractInternationalDiallingCode(String number);
     ...
     */
    def Collection<Country> countries(String internationalDiallingCode)
