  ...
  withinContext { globalContext =>
    {
      ...
      List("dust-full-1.2.2", "dust-helpers-1.1.1").foreach(scriptName => {
        s"resources/public/js/${scriptName}.js".withResource(reader => {
      ...
      templateNames.foreach(templateName => {
        ...
        compileScope.put("rawSource", compileScope, Source.fromURL(s"resources/template/${templateName}.dust".asResourceUrl).mkString)
