...
import uk.co.unclealex.callerid.client.places.CallerIdActivityMapper;
import uk.co.unclealex.callerid.client.places.CallerIdPlaceHistoryMapper;
...
import uk.co.unclealex.callerid.shared.service.PhoneNumberFormatterImpl;
 ...
 *
 */
public class CallerIdInternalModule extends AbstractGinModule {

	@Override
	protected void configure() {
		bind(EventBus.class).to(SimpleEventBus.class).in(Singleton.class);
		bind(PlaceHistoryMapper.class).to(CallerIdPlaceHistoryMapper.class).in(Singleton.class);
		...
		bind(PhoneNumberFormatter.class).to(PhoneNumberFormatterImpl.class);
	}
